...
import { findNameEnd } from './find-name-end.js'
import { isValidAttributeTypeName } from './is-valid-attribute-type-name.js'
import { readAttributeValue } from './read-attribute-value.js'
 ...
 */
export function readAttributePair({ searchBuffer, startPos }) {
  let pos = startPos
  ...
  const attributeName = searchBuffer
    .subarray(nameStartPos, nameEndPos)
    .toString('utf8')
