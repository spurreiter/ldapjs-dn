import { escapeValue } from './utils/escape-value.js'
import { isDottedDecimal } from './utils/is-dotted-decimal.js'
  ...
  toString({ unescaped = false } = {}) {
    ...
    for (const entry of this.#attributes.values()) {
      ...
      if (isHexEncodedValue(entry.value)) {
        ...
        Object.prototype.toString.call(entry.value) === '[object BerReader]'
      ) {
        let encoded = '#'
